...
<div id="container">
    ...
    <table>
  		<tr>
    		<td>
			  <?php $key="Subtitle:"; if (get_custom_field($key)!='') { echo get_custom_field($key);?> </br> <?php } ?>
			  <?php $key="By:"; if (get_custom_field($key)!='') { echo $key; ?> <?php echo get_custom_field($key);?> </br> <?php } ?>
              <?php $key="Translated By:"; if (get_custom_field($key)!='') { echo $key; ?> <?php echo get_custom_field($key);?> </br> <?php } ?>
              ...
              <?php $key="Lyrics and Book by:"; if (get_custom_field($key)!='') { echo $key; ?> <?php echo get_custom_field($key);?> </br> <?php } ?>
              ...
              <?php $key="Musical Director:"; if (get_custom_field($key)!='') { echo $key; ?> <?php echo get_custom_field($key);?> </br> <?php } ?>
              <?php $key="Choreographer:"; if (get_custom_field($key)!='') { echo $key; ?> <?php echo get_custom_field($key);?> </br> <?php } ?>
              ...
              <?php $key="Company:"; if (get_custom_field($key)!='') {echo get_custom_field($key);?> </br> <?php } ?>
  ...
  <tr>
   ...
   <!--#excerpt-->
	...
	<div id ="gallery">
		<?php $key="Gallery ID"; if (get_custom_field($key)<1) {?> No gallery avilable at this time.<?php 
		} else {
			$scode='[simpleviewer gallery_id='.get_custom_field('Gallery ID').']';
            echo do_shortcode($scode);
            $key="Photos by:"; if (get_custom_field($key)!='') { echo $key; ?> <?php echo get_custom_field($key);}
            } ?>
  	</div> <!--#gallery-->
