jQuery(document).ready(function() {
	...
	jQuery('.sv-delete').click(function() {
		return confirm('Are you sure you want to delete all the galleries and reset the Gallery Id to zero?');
	});
	jQuery('.sv-reset').click(function() {
		return confirm('Are you sure you want to reset the default values of the gallery options to their original values?');
	});
