<fieldset>
	...
	<div id="toggleable">
		...
		<div class="col1">
			<label class="info">Image Source</label>
		</div>
		<div class="col3">
		...
		<div class="col3">
			<input type="checkbox" id="showOpenButton" name="showOpenButton" value="true" <?php checked('true', $custom_values['showOpenButton']); ?> />
		</div>
		...
		<div class="col3">
			<input type="checkbox" id="showFullscreenButton" name="showFullscreenButton" value="true" <?php checked('true', $custom_values['showFullscreenButton']); ?> />
		</div>
		...
		<div class="col1">
			<label for="transparent-background" class="info">Background Transparent</label>
		</div>
		<div class="col3">
			<input type="checkbox" id="transparent-background" name="transparent-background" value="true" <?php checked('transparent', $custom_values['e_bgColor']); ?> />
		</div>
		...
		<div class="col3">
			<input type="checkbox" id="e_useFlash" name="e_useFlash" value="true" <?php checked('true', $custom_values['e_useFlash']); ?> />
		</div>
